...
{
    auto f = ufps::BoundedFloat<0.f, 10.f>{};
    ASSERT_FLOAT_EQ(f.value(), 0.f);
    ASSERT_FLOAT_EQ(*f, 0.f);

    static_assert(IsValidBoundedNumber<0.0f, 0.0f, 10.f>);
    static_assert(*ufps::BoundedFloat<0.f, 10.f>{} == 0.f);
    static_assert(ufps::BoundedFloat<0.f, 10.f>::min == 0.f);
    static_assert(ufps::BoundedFloat<0.f, 10.f>::max == 10.f);
    static_assert(std::same_as<decltype(f)::type, float>);
}

TEST(bounded_number, default_ctor_out_of_range)
{
    ASSERT_THROW((ufps::BoundedFloat<1.f, 10.f>{}), ufps::Exception);

    static_assert(!IsValidBoundedNumber<0.f, 1.f, 10.f>);
}

TEST(bounded_number, value_ctor)
{
    auto f = ufps::BoundedFloat<0.f, 10.f>{2.2f};
    ASSERT_FLOAT_EQ(f.value(), 2.2f);
    ASSERT_FLOAT_EQ(*f, 2.2f);

    static_assert(IsValidBoundedNumber<2.2f, 0.f, 10.f>);
    static_assert(*ufps::BoundedFloat<0.f, 10.f>{2.2f} == 2.2f);
}

TEST(bounded_number, value_ctor_out_of_range)
{
    ASSERT_THROW((ufps::BoundedFloat<1.f, 10.f>{11.f}), ufps::Exception);

    static_assert(!IsValidBoundedNumber<11.f, 0.f, 10.f>);
}

TEST(bounded_number, equality)
{
    auto f = ufps::BoundedFloat<1.f, 10.f>{3};
...
{
    auto f = ufps::BoundedFloat<1.f, 10.f>{3.3f};
...
{
    auto f1 = ufps::BoundedFloat<1.f, 10.f>{3.f};
    auto f2 = ufps::BoundedFloat<2.f, 4.f>{f1};

    ASSERT_FLOAT_EQ(*f2, 3.f);
}
